...
#include "Graph_lib/std_lib_facilities.h"
...
int main() {
    ...
    //win.wait_for_button(); Dette funksjonskallet gjør at aplikasjonen fryser når man prøver å lukke applikasjonen, løsning er å kalle Fl::run(), da fungerer lukkeknappen.
    Fl::run();
};
